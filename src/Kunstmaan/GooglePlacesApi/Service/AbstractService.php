...
namespace Kunstmaan\GooglePlacesApi\Service;

use GuzzleHttp\Client;
use GuzzleHttp\Psr7\Response;
use Kunstmaan\GooglePlacesApi\Configurator\ConfiguratorCollectionInterface;
use Kunstmaan\GooglePlacesApi\Configurator\ConfiguratorInterface;
